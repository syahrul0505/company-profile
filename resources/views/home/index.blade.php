...
<div class="main">
        ...
        <!--hero section start-->
        <section class="section section-lg section-header bg-soft" style="background: url('assets/img/bg-wave-twin.svg')no-repeat center bottom">
            <div class="container">
                <div class="row align-items-center pt-lg-6 pt-md-6">
                    <div class="col-md-6 col-lg-6 mb-4 mb-md-4 mb-lg-0">
                        <div class="hero-slider-content">
                            <h1 class="display-2">Investments Stock & Consultancy
                            </h1>
                            <p class="lead">Professionally restore B2B imperatives for cooperative. Rapidiously pursue whereas multimedia based optimal solutions whereas revolutionary sources.</p>
                            <a href="#" class="btn btn-secondary mt-3">Learn More</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="image-wrap">
                            <img src="assets/img/hero-new-img.png" alt="hero image" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-9">
                        <div class="section-title text-center mb-5">
                            <h2>We Provide Great Services for Your Business</h2>
                            <p>Competently incubate bleeding-edge dynamically network unique processes and standardized web-readiness.</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center position-relative">
                    <div class="col-md-6 col-lg-4 mb-4 mb-md-4 mb-lg-0">
                        <div class="service-card d-flex flex-column text-center py-5 px-5 rounded-custom bg-default text-white h-100">
                            <div class="card-img mb-5">
                                <img src="assets/img/icon/icon-6.svg" width="100" class="img-fluid" alt="icon img">
                            </div>
                            <h3 class="h5">Graphic Design</h3>
                            <p>Conveniently impact effective cutting-edge experiences seamlessly evolve leveraged.</p>
                            <a href="#" class="link-with-icon mt-2 font-weight-bold">View details <span><i class="ti-control-forward"></i></span></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 mb-4 mb-md-4 mb-lg-0">
                        <div class="service-card d-flex flex-column text-center py-5 px-5 rounded-custom bg-secondary text-white h-100">
                            <div class="card-img mb-5">
                                <img src="assets/img/icon/icon-3.svg" width="100" class="img-fluid" alt="icon img">
                            </div>
                            <h3 class="h5">Web Development</h3>
                            <p>Compellingly integrate alternative users whereas multidisciplinary benefits web services whereas .</p>
                            <a href="#" class="link-with-icon mt-2 font-weight-bold">View details <span><i class="ti-control-forward"></i></span></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 mb-4 mb-md-4 mb-lg-0">
                        <div class="service-card d-flex flex-column text-center py-5 px-5 rounded-custom bg-primary text-white h-100">
                            <div class="card-img mb-5">
                                <img src="assets/img/icon/icon-1.svg" width="100" class="img-fluid" alt="icon img">
                            </div>
                            <h3 class="h5">Content Writing</h3>
                            <p>Professionally standardized sources process improvements predominate prospective.</p>
                            <a href="#" class="link-with-icon mt-2 font-weight-bold">View details <span><i class="ti-control-forward"></i></span></a>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="list-unstyled d-flex flex-wrap justify-content-center mb-0">
                            <li class="my-3 mx-3 mx-lg-5">
                                <div class="customer-logo">
                                    <img src="assets/img/client-logos/logo1.png" alt="client logo">
                                </div>
                            </li>
                            <li class="my-3 mx-3 mx-lg-5">
                                <div class="customer-logo">
                                    <img src="assets/img/client-logos/logo4.png" alt="client logo">
                                </div>
                            </li>
                            <li class="my-3 mx-3 mx-lg-5">
                                <div class="customer-logo">
                                    <img src="assets/img/client-logos/logo5.png" alt="client logo">
                                </div>
                            </li>
                            <li class="my-3 mx-3 mx-lg-5">
                                <div class="customer-logo">
                                    <img src="assets/img/client-logos/logo6.png" alt="client logo">
                                </div>
                            </li>
                            <li class="my-3 mx-3 mx-lg-5">
                                <div class="customer-logo">
                                    <img src="assets/img/client-logos/logo7.png" alt="client logo">
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-md-12 col-lg-5">
                        <div class="video-promo-content">
                            ...
                            <a href="#" class="btn btn-primary  btn-secondary  mt-3">View Services</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                        ...
                        <div class="icon-box text-center">
                            ...
                            <h2 class="h5">Total Marketing Solutions</h2>
        ...
        <!--cta section start-->
        <section class="text-white" style="background: url('assets/img/slider-img-5.jpg')no-repeat center center / cover">
            <div class="section shadow-lg bg-gradient-primary">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-8">
                            <div class="call-to-action-content text-white text-center mb-5">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-10 col-lg-9">
                            <div class="heighlight-list-wrap text-center">
                                <ul class="list-inline highlight-list">
                                    <li class="list-inline-item bg-soft-alt py-4 px-3 rounded-custom mb-4 mb-md-4 mb-lg-0">
                                        <h4 class="counter h2 mb-0" data-count="100">0</h4>
                                        <span class="text-muted font-weight-bold font-small">Happy Client</span>
                                    </li>
                                    <li class="list-inline-item bg-soft-alt py-4 px-3 rounded-custom mb-4 mb-md-4 mb-lg-0">
                                        <h4 class="counter h2 mb-0" data-count="60">0</h4>
                                        <span class="text-muted font-weight-bold font-small">Win Awards</span>
                                    </li>
                                    <li class="list-inline-item bg-soft-alt py-4 px-3 rounded-custom mb-4 mb-md-4 mb-lg-0">
                                        <h4 class="counter h2 mb-0" data-count="555">0</h4>
                                        <span class="text-muted font-weight-bold font-small">Dedicated Support</span>
                                    </li>
                                    <li class="list-inline-item bg-soft-alt py-4 px-3 rounded-custom mb-4 mb-md-4 mb-lg-0">
                                        <h4 class="counter h2 mb-0" data-count="200">0</h4>
                                        <span class="text-muted font-weight-bold font-small">Client Testimonials</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="portfolio-container" id="MixItUp">
                            <div class="mix portfolio-item branding" data-ref="mixitup-target">
                                <div class="portfolio-wrapper border border-variant-soft rounded bg-soft p-2">
                                    <a href="project-details.html" target="_blank">
                                        ...
                                        <img class="img-fluid" src="assets/img/portfolios/3.jpg" alt="portfolio" />
                            ...
                            <div class="mix portfolio-item other animation" data-ref="mixitup-target">
                                <div class="portfolio-wrapper border border-variant-soft rounded bg-soft p-2">
                                    <a href="project-details.html" target="_blank">
                                        <div class="content-overlay"></div>
                                        <img class="img-fluid" src="assets/img/portfolios/2.jpg" alt="portfolio" />
                                        <div class="content-details fadeIn-bottom text-white">
                            ...
                            <div class="mix portfolio-item animation" data-ref="mixitup-target">
                                <div class="portfolio-wrapper border border-variant-soft rounded bg-soft p-2">
                                    <a href="project-details.html" target="_blank">
                                        <div class="content-overlay"></div>
                                        <img class="img-fluid" src="assets/img/portfolios/4.jpg" alt="portfolio" />
                                        <div class="content-details fadeIn-bottom text-white">
                            ...
                            <div class="mix portfolio-item branding" data-ref="mixitup-target">
                                <div class="portfolio-wrapper border border-variant-soft rounded bg-soft p-2">
                                    <a href="project-details.html" target="_blank">
                                        <div class="content-overlay"></div>
                                        <img class="img-fluid" src="assets/img/portfolios/1.jpg" alt="portfolio" />
                                        <div class="content-details fadeIn-bottom text-white">
                                            <h5 class="text-white mb-1">Web UI/UX Design</h5>
                                            <p>Web, Design</p>
                                        </div>
                            ...
                            <div class="mix portfolio-item animation other" data-ref="mixitup-target">
                                <div class="portfolio-wrapper border border-variant-soft rounded bg-soft p-2">
                                    <a href="project-details.html" target="_blank">
                                        <div class="content-overlay"></div>
                                        <img class="img-fluid" src="assets/img/portfolios/5.jpg" alt="portfolio" />
                                        <div class="content-details fadeIn-bottom text-white">
                            ...
                            <div class="mix portfolio-item branding " data-ref="mixitup-target">
                                <div class="portfolio-wrapper border border-variant-soft rounded bg-soft p-2">
                                    <a href="project-details.html" target="_blank">
                                        <div class="content-overlay"></div>
                                        <img class="img-fluid" src="assets/img/portfolios/6.jpg" alt="portfolio" />
                                        <div class="content-details fadeIn-bottom text-white">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4 mb-4 mb-md-4 mb-lg-0 mb-4">
                        <div class="card bg-white border-variant-soft shadow-soft">
                            <div class="blog-img position-relative">
                                <img src="assets/img/blog/4.jpg" class="card-img-top rounded-top" alt="themetags office">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-4 mb-md-4 mb-lg-0 mb-4">
                        <div class="card bg-white border-variant-soft shadow-soft">
                            <div class="blog-img position-relative">
                                <img src="assets/img/blog/2.jpg" class="card-img-top rounded-top" alt="themetags office">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-4 mb-md-4 mb-lg-0 mb-4">
                        <div class="card bg-white border-variant-soft shadow-soft">
                            <div class="blog-img position-relative">
                                <img src="assets/img/blog/1.jpg" class="card-img-top rounded-top" alt="themetags office">
                            ...
                            <div class="card-body">
                                <div class="media d-flex align-items-center justify-content-between">
                                    <div class="post-group">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="23k followers">
                                            <img class="avatar avatar-xs mr-2 img-fluid rounded-circle border border-variant-primary p-1" src="assets/img/clients/client-5.jpg" alt="admin"> <span class="small">Joe B</span>
                                        </a>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <span class="small"><span class="far fa-calendar-alt mr-2"></span>15 March 2020</span>
                ...
                <div class="row">
                        ...
                        <div class="profile-card">
                            <div class="card bg-soft  shadow-sm animate-hover border-variant-soft">
                                <div class="profile-image-small  bg-white  shadow-inset shadow border border-light rounded-circle p-1 mt-5 mb-4">
                                    <img src="assets/img/team/team-6.jpg" class="card-img-top rounded-circle" alt="Christopher Avatar">
                                </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-md-4 mb-lg-0 mb-4">
                        <div class="profile-card">
                            <div class="card bg-soft  shadow-sm animate-hover border-variant-soft">
                                <div class="profile-image-small  bg-white  shadow-inset shadow border border-light rounded-circle p-1 mt-5 mb-4">
                                    <img src="assets/img/team/team-1.jpg" class="card-img-top rounded-circle" alt="Christopher Avatar">
                                </div>
                                <div class="card-body text-center px-5 pb-5 pt-0">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-md-4 mb-lg-0 mb-4">
                        <div class="profile-card">
                            <div class="card bg-soft  shadow-sm animate-hover border-variant-soft">
                                <div class="profile-image-small  bg-white  shadow-inset shadow border border-light rounded-circle p-1 mt-5 mb-4">
                                    <img src="assets/img/team/team-4.jpg" class="card-img-top rounded-circle" alt="Christopher Avatar">
                                </div>
                                <div class="card-body text-center px-5 pb-5 pt-0">
                ...
                <div class="row">
                        ...
                        <div class="testimonial-single shadow-sm bg-white rounded-custom p-5">
                            ...
                            <div class="d-flex justify-content-md-between justify-content-lg-between align-items-center pt-3">
                                <div class="media align-items-center">
                                    <img src="assets/img/team/team-4.jpg" alt="team" class="avatar avatar-sm mr-3">
                    ...
                    <div class="col-12 col-lg-6 mb-4 mb-md-4 mb-lg-0">
                        <div class="testimonial-single shadow-sm bg-white rounded-custom p-5">
                            ...
                            <div class="d-flex justify-content-md-between justify-content-lg-between align-items-center pt-3">
                                <div class="media align-items-center">
                                    <img src="assets/img/team/team-1.jpg" alt="team" class="avatar avatar-sm mr-3">
                                    <div class="media-body">
